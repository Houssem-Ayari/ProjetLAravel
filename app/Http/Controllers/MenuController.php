...
class MenuController extends Controller
{
    ...
    {
        $menu= new Menu ([
            'nommenu'=>$request->get('nom_menu'),
            'descriptionmenu'=>$request->get('description_menu')
        ]);
        $menu->save();
    ...
    {
        $menu = Menu::find($id);
        $menu->nommenu = $request->get('nom_menu');
        $menu->descriptionmenu = $request->get('description_menu');
